package com.bril.base.ui.dialog.holder;
...
import com.bril.base.ui.dialog.DialogUIUtils;
import com.bril.base.ui.dialog.adapter.TieAdapter;
import com.bril.base.ui.dialog.bean.BuildBean;
import com.bril.base.ui.dialog.listener.OnItemClickListener;
import com.bril.base.ui.dialog.widget.DialogUIDividerItemDecoration;
...
public class SheetHolder extends SuperHolder {
    ...
    public void assingDatasAndEvents(final Context context, final BuildBean bean) {
        ...
        bean.mAdapter.setOnItemClickListener(position -> {
            DialogUIUtils.dismiss(bean.dialog, bean.alertDialog);
