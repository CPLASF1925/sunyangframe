...
public class Person {
    ...
    @Generated(hash = 1985106282)
    public Person(Long id, int memberSex, String memberLastX,
                  String memberNickname, String memberIcon, String memberMobile,
                  int memberId, String memberLastExperience, String memberLevelName,
